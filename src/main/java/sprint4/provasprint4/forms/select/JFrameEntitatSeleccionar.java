...
public class JFrameEntitatSeleccionar extends javax.swing.JFrame {
    ...
    public static String nom_prop;
    public static String descripcio_prop;
    ...
    public JFrameEntitatSeleccionar(LlistaEntitats ll_enti, LlistaProjectes ll_proj, LlistaPropostes ll_prop,
                                    LlistaPresupostos ll_pres,  String nom_prop, String descripcio_prop, int opcio, String data_alta) {
        ...
        try {
            JFrameEntitatSeleccionar.ll_enti = ll_enti;
            JFrameEntitatSeleccionar.ll_proj = ll_proj;
            JFrameEntitatSeleccionar.ll_prop = ll_prop;
            JFrameEntitatSeleccionar.ll_pres = ll_pres;
            JFrameEntitatSeleccionar.nom_prop = nom_prop;
            JFrameEntitatSeleccionar.descripcio_prop = descripcio_prop;
            JFrameEntitatSeleccionar.opcio = opcio;
            JFrameEntitatSeleccionar.data_alta = data_alta;
            initComponents();
    ...
    private void initComponents() {
        ...
        taula_entitats = new javax.swing.JTable();
        ...
        taula_entitats.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        taula_entitats.getTableHeader().setReorderingAllowed(false);
        taula_entitats.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                taula_entitatsMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(taula_entitats);
    ...
    private void taula_entitatsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_taula_entitatsMouseClicked
        selectedItem = (int) taula_entitats.getValueAt(taula_entitats.getSelectedRow(), 0) - 1; // Cada vegada que fem click a algun element de la taula
//fem que l'atribut selectedItem s'actualitzi per a que sigui l'id de l'element
    }//GEN-LAST:event_taula_entitatsMouseClicked
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (opcio == 0) {
            JFrameAltaProposta g_a = new JFrameAltaProposta(ll_enti, ll_prop, ll_proj, ll_pres,
                    selectedItem, nom_prop, descripcio_prop, data_alta);
            ...
            JFrameModificarPropostes g_b = new JFrameModificarPropostes(ll_enti, ll_prop, ll_proj, ll_pres,
                    selectedItem, nom_prop, descripcio_prop, data_alta); // Al fer click a afegirGrup, instanciem el jframe JFrameAltaProposta
    ...
    private javax.swing.JTable taula_entitats;
